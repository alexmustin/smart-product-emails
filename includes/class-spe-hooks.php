...
class SmartProductEmails_Hooks {
	...
	public static function init() {
		...
		do_action('smartproductemails_free_loaded');
	}
	...
	public static function product_admin_controls($product_id, $status, $message_id) {
		do_action('smartproductemails_product_admin_controls', $product_id, $status, $message_id);
	}
	...
	public static function product_admin_extra_fields($product_id) {
		do_action('smartproductemails_product_admin_extra_fields', $product_id);
	}
	...
	public static function filter_message_content($content, $message_id, $status) {
		return apply_filters('smartproductemails_filter_message_content', $content, $message_id, $status);
	}
	...
	public static function settings_page_sections() {
		do_action('smartproductemails_settings_page_sections');
	}
	...
	public static function admin_enqueue_scripts($hook) {
		do_action('smartproductemails_admin_enqueue_scripts', $hook);
	}
	...
	public static function filter_placeholders($placeholders, $order = null) {
		return apply_filters('smartproductemails_filter_placeholders', $placeholders, $order);
	}
